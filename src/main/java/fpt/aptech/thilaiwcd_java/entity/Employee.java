package fpt.aptech.thilaiwcd_java.entity;
...
public class Employee {
    ...
    private void checkValid() {
        ...
        if (birthday == null || birthday.length() == 0) {
            errors.put("email", "Please enter birthday.");
        }
        if (address == null || address.length() == 0) {
            errors.put("email", "Please enter address.");
        }
        if (position == null || position.length() == 0) {
            errors.put("email", "Please enter position.");
        }
        if (department == null || department.length() == 0) {
            errors.put("email", "Please enter department.");
        }
    }
